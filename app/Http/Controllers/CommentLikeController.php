...
class CommentLikeController extends Controller
{
    ...
    public function __construct(CommentLikeContract $commentLikeContract, LikeTransformer $likeTransformer)
    {
    ...
    {
        $likes = $this->commentLikeRepository->search($request->input());
    ...
    public function all()
    {
        return $this->commentLikeRepository->getAll();
    }
